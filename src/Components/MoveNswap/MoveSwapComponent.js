                ...
                <div className='m-4 p-4'>
                    <ul>
                        {leftData && leftData.map((data, index) => {
                            return <li className='cursor-pointer' onDoubleClick={() => handleMoveLeft(index)} key={index}>{data}</li>
                        })}
                ...
                <div className='m-4 p-4'>
                    <ul>
                        {rightData && rightData.map((data, index) => {
                            return <li className='cursor-pointer' onDoubleClick={() => handleMoveRight(index)} key={index}>{data}</li>
                        })}
